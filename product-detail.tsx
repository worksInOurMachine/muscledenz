    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <nav className="flex text-sm">
          ...
          <Link href="/supplements" className="text-muted-foreground hover:text-red-600">
            Supplements
          </Link>
          <span className="mx-2 text-muted-foreground">/</span>
          <span className="text-foreground">Premium Whey Protein</span>
        </nav>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="space-y-6 md:col-span-1">
          <div>
            ...
            <h1 className="text-3xl font-bold">Premium Whey Protein Isolate</h1>
            <div className="mt-2 flex items-center">
              <div className="flex">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className={`h-5 w-5 ${i < 4 ? "fill-red-600 text-red-600" : "text-muted-foreground"}`}
                  />
                ))}
              </div>
          ...
          <div>
            <div className="flex items-baseline">
              ...
              <span className="ml-2 text-sm text-muted-foreground line-through">$69.99</span>
          ...
          <div className="flex flex-col space-y-2 sm:flex-row sm:space-x-2 sm:space-y-0">
            <Button className="flex-1 bg-red-600 text-white hover:bg-red-500" size="lg">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        <th className="p-3 text-left">Amount Per Serving</th>
            ...
            <TabsContent value="reviews" className="pt-4">
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button className="bg-red-600 text-white hover:bg-red-500">Write a Review</Button>
                </div>
                    ...
                    <div className="rounded-lg border p-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center">
                          ...
                          <span className="ml-2 w-1/4 text-right text-sm">65%</span>
                        </div>
                        <div className="flex items-center">
                          ...
                          <span className="ml-2 w-1/4 text-right text-sm">20%</span>
                        </div>
                        <div className="flex items-center">
                          ...
                          <span className="ml-2 w-1/4 text-right text-sm">10%</span>
                        </div>
                        <div className="flex items-center">
                          ...
                          <span className="ml-2 w-1/4 text-right text-sm">3%</span>
                        </div>
                        <div className="flex items-center">
                          ...
                          <span className="ml-2 w-1/4 text-right text-sm">2%</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    {[1, 2, 3].map((review) => (
                      <Card key={review}>
                        <CardContent className="p-4">
                          ...
                          <h4 className="mb-1 font-medium">Great protein, mixes well</h4>
                          <p className="text-sm text-muted-foreground">
                            I've been using this protein for about a month now and I'm very happy with it. It mixes well
                            with no clumps and the chocolate flavor is delicious. I've noticed better recovery after my
                            workouts.
                          </p>
                        </CardContent>
                      </Card>
