    ...
    return (
        <Card className="relative border-0 shadow-md bg-slate-100 h-[370px] sm:h-[450px] md:h-[450px] flex flex-col p-4">
            ...
            <div className="absolute top-4 left-4">
                <div
                    className={`w-4 h-4 border-2 ${product.isVeg ? "border-green-600" : "border-red-600"} rounded-sm`}
                >
                    <div className={`w-2 h-2 m-0.5 rounded-sm ${product.isVeg ? "bg-green-600" : "bg-red-600"}`} />
                </div>
            </div>
