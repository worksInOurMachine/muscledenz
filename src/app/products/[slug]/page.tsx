...
import { Star, Heart, Minus, Plus, ShoppingCart, Zap, Leaf } from "lucide-react"
...
export default function ProductDetailsPage() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        <div className="text-center">
          ...
          <Link href={"/products"} className=" bg-black text-white px-4 py-2 rounded-[5px] mt-4">Products</Link>
      </div>
    )
  }
  ...
  return (
    <>
      {
        product ? <div className="min-h-screen bg-background">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                  ...
                  <div className="flex gap-2 overflow-x-auto pb-2">
                    {images.map((image: any, index) => (
                      <button
                        ...
                        className={`flex-shrink-0 w-20 h-20 rounded-md overflow-hidden border-2 transition-colors ${selectedImageIndex === index ? "border-primary" : "border-border"
                          }`}
                      >
                        <Image
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <h1 className="text-3xl lg:text-4xl font-bold text-foreground mb-2 text-balance">{product.name}</h1>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <Button variant="outline" size="lg" className="w-full bg-transparent" disabled={product.stock === 0} onClick={addToCart} >
                      <ShoppingCart className="w-4 h-4 mr-2" />
                      Add to Cart
                    </Button>

                    <Button size="lg" className="w-full" disabled={product.stock === 0} onClick={handleBuyNow}>
        ...
        </div> : <div className="flex justify-center flex-col items-center h-[90vh]">
          <h5 className=" font-bold text-[20px]">Product not found</h5>
          <Link href={"/products"} className=" bg-black px-4 py-2 rounded-[5px] mt-4">Products</Link>
        </div>
      }
    </>
  )
